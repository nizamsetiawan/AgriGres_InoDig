...
import 'package:agrigres/features/admin/screens/crud/create_edit_category_screen.dart';
...
class CategoriesManagementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(CategoriesManagementController());
            ...
            SliverAppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () => Get.to(() => const CreateEditCategoryScreen()),
            ...
            itemBuilder: (context) => [
              PopupMenuItem(
                ...
                onTap: () => Future.delayed(
                  ...
                  () => Get.to(() => CreateEditCategoryScreen(category: category)),
                ),
              ),
              PopupMenuItem(
                child: const Row(
