...
class KomoditasRekapitulasiDataList extends StatelessWidget {
  final List<KomoditasRekapitulasiData> data;
  final int rataRataProvinsi;

  const KomoditasRekapitulasiDataList({
    super.key,
    required this.data,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Rata-rata Provinsi Summary
        if (rataRataProvinsi > 0) _buildRataRataProvinsi(context),
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: KomoditasRekapitulasiDataCard(item: item),
            );
          },
        ),
      ],
  ...
  Widget _buildRataRataProvinsi(BuildContext context) {
    final textTheme = Theme.of(context).textTheme;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            _formatCurrency(rataRataProvinsi),
            style: textTheme.bodyMedium?.copyWith(
...
class KomoditasRekapitulasiDataCard extends StatelessWidget {
  final KomoditasRekapitulasiData item;

  const KomoditasRekapitulasiDataCard({
    super.key,
    required this.item,
  });
  ...
  Widget _buildDataTable(BuildContext context, List<KomoditasByDate> validDates) {
    final textTheme = Theme.of(context).textTheme;
