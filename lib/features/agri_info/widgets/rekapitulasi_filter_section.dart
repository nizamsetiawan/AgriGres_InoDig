...
class RekapitulasiFilterSection extends StatelessWidget {
  const RekapitulasiFilterSection({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<RekapitulasiController>();
  ...
  void _showLevelHargaPicker(BuildContext context, RekapitulasiController controller) {
